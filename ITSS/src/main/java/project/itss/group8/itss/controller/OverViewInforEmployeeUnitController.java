...
import project.itss.group8.itss.helper.Impl.LoginServiceImpl;
import project.itss.group8.itss.helper.Impl.OverViewInforEmployeeUnitServiceImpl;
...
public class OverViewInforEmployeeUnitController extends WorkspaceController {
...

            {
                ...
                button.setOnAction(event -> {
                    if(buttonStyleClass.equals("view-button"))
                    {
                        ...
                        try {
                            changeWorkspace("/project/itss/group8/itss/view/manager/DetailEmployeeUnit.fxml");
                        } catch (IOException e) {
    ...
    void backToPreviousPage(ActionEvent event) {
        try {
            changeWorkspace("/project/itss/group8/itss/view/manager/ViewEmployeeUnit.fxml");
        }catch (Exception e) {
