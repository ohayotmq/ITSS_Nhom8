...
public class OverViewInforEmployeeUnitServiceImpl implements OverViewInforEmployeeUnitService {
    ...
    @Override
    public ObservableList<TimekeepingOverview> getTimekeepingByMonth(LocalDate time, LocalDateTime start, LocalDateTime end, int employeeId) {
        ObservableList<TimekeepingOverview> timekeepingOverviews = FXCollections.observableArrayList();
        List<LogInfor> logInfors = logInforRepository.getLogInforByMonth(time.getMonth().getValue(),time.getYear(), employeeId);
